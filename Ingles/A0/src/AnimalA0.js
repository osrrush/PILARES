 ...
 */
let vocabulary = ['Bear', 'Bee', 'Bird', 'Cat', 'Chicken', 'Cow', 'Crocodile',
    'Dog', 'Donkey', 'Duck', 'Elephant', 'Fish', 'Frog', 'Giraffe', 'Goat',
    'Hippo', 'Horse', 'Jellyfish', 'Lizard', 'Monkey', 'Mouse', 'Mice',
    'Polar bear', 'Sheep', 'Snake', 'Spider', 'Tiger', 'Zebra', 'Turtle'];

const titulo = 'Animal A0'; //Titulo del juego
