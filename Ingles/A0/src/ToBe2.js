 ...
 */
let vocabulary = ['fine','a','student','child','happy','girl','an','beautiful',
    'flower','brothers','England','from','at','school'];

let vocabularyS =['bien','un / una','estudiante','niño/niña','feliz','niña/chica',
    'un/una','hermosa','flor','hermanos','Inglaterra','de','en', 'escuela'];

let phrases = ['I am fine', 'You are a student', 'He is a child',
    'She is an happy girl','It is a beautiful flower','We are brothers',
    'You are from England', 'They are at school'];

let phrasesS = [['Yo estoy bien','Estoy bien'],['Tú eres un estudiante',
        'Tú eres una estudiante','Eres un estudiante','Eres una estudiante'],
    ['Él es un niño','Es un niño'],['Ella es una niña feliz','Ella es una chica feliz',
    'Es una niña feliz','Es una chica feliz'],['Es una flor hermosa'],
    ['Nosotros somos hermanos','Somos hermanos'],['Tú eres de Inglaterra','Eres de Inglaterra',
    'Ustedes son de Inglaterra','Son de Inglaterra'],
    ['Ellos están en la escuela','Ellas están en la escuela','Están en la escuela']];
