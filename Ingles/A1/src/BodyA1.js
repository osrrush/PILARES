 ...
 */
let vocabulary = ['back','beard','moustache','neck','shoulder','stomach','tooth','teeth'];

const titulo = 'The body A1'; //Titulo del juego
...
class SW extends Phaser.Scene {
    ...
    corregir() {
        ...
        var r = document.getElementById('respuesta').value;
        var resp = this.vocabulary2[rc % vocabulary.length].toLowerCase();
