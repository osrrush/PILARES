 ...
 */
let animals = ['ant', 'bear', 'beaver', 'bee', 'bird', 'butterfly', 'cat', 
    'chicken', 'cockroach', 'cow', 'cricket', 'crocodile', 'crow', 'dog', 
    'dolphin', 'donkey', 'duck', 'eagle', 'elephant', 'fish', 'fly', 'fox', 
    'frog', 'giraffe', 'goat', 'gorilla', 'hen', 'hippopotamus', 'horse', 
    'kangaroo', 'lion', 'monkey', 'mouse', 'penguin', 'pig', 'rabbit', 'racoon', 
    'seal', 'shark', 'sheep', 'snake', 'spider', 'squirrel', 'tiger', 'turkey', 
    'turtle', 'whale', 'wolf', 'worm', 'zebra'];
