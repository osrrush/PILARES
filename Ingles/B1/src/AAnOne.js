...
let vocabularyS =['un/una','doctor','gordo','niña','linda','rojo','flor','feliz','mi',
    ...
    'madre','este/esta'];
let opciones = [['a'],['an'],["one"]];

let rellenar = ['I use _ heater because my bedroom is really cold', 
    'There are _ hundred centimeters in a meter',
    "I've got two brothers and _ sister",
    'I invited three friends, but only _ came',
    '_ a year is not enought for me',
    'I live on my own in _ flat',
    "She's got _ hundred euros",
    "We go there twice _ month",
    'I went to the village with _ friend',
    'She gave me _ hamburger, not two', 
    'I want to buy _ umbrella',
    'My cousin works at _ university',
    "I've got _ uncle and two aunts"];
...
class CF extends Phaser.Scene{
    ...
    create(){
        ...
        this.div = document.createElement('h1');
        this.div.setAttribute("style","width = 1000px");
    ...
    corregir(opc){
        ...
        console.log(respuestas[indices[rc]]);
        for(var k=0;k<respuestas[indices[rc]].length;k++){
            if(opc === respuestas[indices[rc]][k] ){
                //console.log("Correcto");
                b=0.25;
                rc++;
                this.sound.stopAll();
                ...
                if(k === respuestas[indices[rc]].length -1){
                    w.play();
                    a=0.5;
                }
            }
