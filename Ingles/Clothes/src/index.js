 ...
 */
let vocabulary = ['bathing suit', 'bathrobe', 'belt', 'blouse', 'boots', 
    'cap', 'coat', 'dinner jacket', 'dress', 'gloves', 'hat', 'heels', 
    'jacket', 'jeans', 'overalls', 'overcoat', 'pajamas', 
    'raincoat', 'sandals', 'scarf', 'shirt', 'shoes', 'shorts', 'stockings', 'skirt',
    'slippers', 'sneakers', 'socks', 'suit', 'sweater', 'tie', 't-shirt', 'underwear',
    'vest'];

const titulo = 'Clothes'; //Titulo del juego
...
class Explorar extends Phaser.Scene{
	...
	this.add.graphics().lineStyle(2, 0xff0000).strokeRectShape(ini);
        ...
        for( var i=0 ; i < vocabulary.length ; i++ ){
            ...
            var image = this.add.image(x+(i%10)*170 , y+170*Math.floor(i/10) , vocabulary[i]).setInteractive();
