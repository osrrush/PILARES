 ...
 */
let vocabulary = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday',
                    'Saturday', 'Sunday'];
let vocabularyS = ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes',
                    'Sábado', 'Domingo'];

const titulo = 'Days of the week'; //Titulo del juego
