 ...
 */
let vocabulary = ['January', 'February', 'March', 'April', 'May', 'June', 'July',
                    'August', 'September', 'October','November', 'December'];
let vocabularyS = ['Enero', 'Ferbrero', 'Marzo', 'Abril', 'Mayo','Junio','Julio',
                    'Agosto', 'Septiembre','Octubre','Noviembre','Diciembre'];

const titulo = 'Months'; //Titulo del juego
const menulabel = [['Vocabulary'],
    ['Read and choose'],
    ['Listen and choose'],
    ['Listen and write']]; //Opciones menú

const Exp='Escoge el día.';
/*
