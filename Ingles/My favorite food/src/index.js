 ...
 */
let vocabulary = ['peas', 'bread', 'rice', 'onion', 'water', 
    'milk', 'meat', 'potato', 'fish', 'beans', 'sausage', 'egg', 
    'breakfast', 'dinner', 'chocolate', 'cake', 'chicken', 
    'lemonade', 'juice', 'soda', 'burger', 'fries', 'ice cream', 'carrot'];

const titulo = 'My favorite food'; //Titulo del juego
