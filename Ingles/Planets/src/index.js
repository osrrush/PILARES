 ...
 */
let vocabulary = ['Sun', 'Mercury', 'Venus', 'Earth', 'Moon', 'Mars', 'Jupiter',
                    'Saturn', 'Uranus', 'Neptune'];
let vocabularyS = ['Sol', 'Mercurio', 'Venus', 'Tierra', 'Luna','Marte','Jupiter',
                    'Saturno', 'Urano','Neptuno'];

const titulo = 'Planets'; //Titulo del juego
const menulabel = [['Vocabulary'],
    ['Read and choose'],
    ['Listen and choose'],
    ['Listen and write']]; //Opciones menú

const Exp='Escoge el planeta.';
/*
